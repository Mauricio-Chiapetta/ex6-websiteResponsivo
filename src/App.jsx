...
function App() {
  return (
    <div className="bg-slate-200 min-h-screen flex flex-col dark:bg-neutral-800 dark:text-white">
      <div className="bg-[linear-gradient(to_top,rgba(0,0,0,0.8),rgba(0,0,0,0)),url(./assets/people.webp)] bg-cover bg-center bg-no-repeat text-white p-64 min-h-screen flex items-center flex-col text-center ">
        <h2 className="font-bold text-4xl mb-5">Future Tech Conference 2024</h2>
        <p className="mb-5">
      ...
      <div className="flex items-center justify-center text-left gap-20 mb-20">
